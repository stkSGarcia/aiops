...
export const TimelineFilter = Form.create({
  ...
  const onSmartChange = (value) => {
    if (value) {
      props.form.setFieldsValue({goal: []});
    }
  };
  ...
  return (
    <Form onSubmit={handleSubmit} onReset={props.onReset} hideRequiredMark={true}>
      <FormItem {...formItemLayout} label="Session Order">
        <Col span={14}>
          <FormItem>
            {getFieldDecorator('sorter', {
              ...
              <Select placeholder="Please select">
                <Option value="3">Max Duration</Option>
                <Option value="4">Avg Duration</Option>
                <Option value="5">Exception Number</Option>
              </Select>
            )}
          </FormItem>
        </Col>
