...
//
// interface HistoryFileDashboardProps {
...
// }
//
// interface HitoryFileDashboardState {
//   timestamp: string;
//   entryMap: EntryMap;
//   lockMap: LockMap;
//   statistic: any[];
...
// }
//
// export default class HistoryFileDashboard extends React.Component<HitoryFileDashboardState, HistoryFileDashboardProps> {
//   foldLength = 5;
//
...
//     });
//
//     this.props.allHistory.forEach((value, index) => {
//       const filename = (
//         <Link
//           to={{pathname: '/jstack/all_history', state: {filename: value}}}
//           style={{
//             fontSize: '18px',
//             cursor: 'pointer',
//             textDecoration: 'underline',
...
//       historyPage: stored ? storedData.historyPage : 1,
//     }
//     ;
//     Store.dispatch({
//       type: 'jstack',
...
//
//         <div style={Style.block}>
//           <h3 style={{fontWeight: 'bold', marginBottom: '10px'}}>Analyze History </h3>
//           <Table
...
//             pagination={{
//               showQuickJumper: true,
//               onChange: (page) => this.setState({historyPage: page}),
//               current: this.state.historyPage,
//             }}
//           />
//         </div>
//       </div>
