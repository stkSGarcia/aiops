...
interface TotalFileDashboardProps {
  fileInfo: JstackFileInfo;
  history: any;
  locationKey: string;
}

interface TotalFileDashboardState {
  entryMap: EntryMap;
  lockMap: LockMap;
  statistic: any[];
  stateMap: any;
...
export default class FileDashboard extends React.Component<TotalFileDashboardProps, TotalFileDashboardState> {
  foldLength = 5;
